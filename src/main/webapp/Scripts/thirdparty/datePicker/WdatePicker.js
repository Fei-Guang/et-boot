...
(function() {
	...
	var X = window, S = {
		innerHTML : ""
	}, SkinPath = window.DATEPICKER_HOME_URL, M = "document", H = "documentElement", C = "getElementsByTagName", U, A, R, G, a, W = navigator.appName;
	...
	A = J();
	if ($.$wdate)
		K(SkinPath + "skin/WdatePicker.css");
	U = X;
	if ($.$crossFrame) {
		try {
