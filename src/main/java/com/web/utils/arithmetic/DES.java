package com.web.utils.arithmetic;
...
public class DES {
	...
	/*
	 * change the bit(it's length = 4) into the hex
	 * 
	 * return hex
	 */
	...
	/*
	 * change the hex into the bit(it's length = 4)
	 * 
	...
	/*
	 * change the bit(it's length = 64) into the string
	 * 
	 * return string
	 */
